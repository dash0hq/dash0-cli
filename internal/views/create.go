...
func newCreateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Create a new view from a YAML or JSON definition file. Use '-f -' to read from stdin.` + internal.CONFIG_HINT,
		Example: `  # Create from a YAML file
  dash0 views create -f view.yaml

  # Create from stdin
  cat view.yaml | dash0 views create -f -

  # Validate without creating
  dash0 views create -f view.yaml --dry-run`,
