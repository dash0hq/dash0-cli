...
API_TESTS=(
  ...
  "${SCRIPT_DIR}/test_apply_notification_channel_assets_warning.sh"
  "${SCRIPT_DIR}/test_apply_time_series_aggregation_idempotency.sh"
  ...
  "${SCRIPT_DIR}/test_time_series_aggregation_roundtrip.sh"
